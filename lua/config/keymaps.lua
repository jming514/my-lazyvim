...
-- Harpoon
map("n", "<leader>fa", '<cmd>lua require("harpoon.mark").add_file()<cr>', { desc = "Harpoon mark" })
map("n", "<leader>fw", '<cmd>lua require("harpoon.ui").toggle_quick_menu()<cr>', { desc = "Harpoon quick menu" })
